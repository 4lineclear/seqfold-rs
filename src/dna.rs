...
pub fn nn() -> &'static BpEnergy {
    pub static RAW_NN: [(&str, (f64, f64)); 14] = [
        ("init", (0.2, -5.7)),
        ("init_G/C", (0.0, 0.0)),
        ("init_A/T", (2.2, 6.9)),
        ("sym", (0.0, -1.4)),
    ...
    pub static NN: LazyLock<BpEnergy> = LazyLock::new(|| {
        ...
        for (s, v) in RAW_NN {
            ...
            nn.insert(s.chars().rev().collect(), v);
        }
        nn
    });
    &NN
...
pub fn internal_mm() -> &'static BpEnergy {
    pub static RAW_INTERNAL_MM: [(&str, (f64, f64)); 51] = [
        ("AG/TT", (1.0, 0.9)),
        ("AT/TG", (-2.5, -8.3)),
        ("CG/GT", (-4.1, -11.7)),
        ("CT/GG", (-2.8, -8.0)),
...
pub fn terminal_mm() -> &'static BpEnergy {
    pub static RAW_TERMINAL_MM: [(&str, (f64, f64)); 48] = [
        ("AA/TA", (-3.1, -7.8)),
        ("TA/AA", (-2.5, -6.3)),
        ("CA/GA", (-4.3, -10.7)),
        ("GA/CA", (-8.0, -22.5)),
...
pub fn de() -> &'static BpEnergy {
    pub static RAW_DE: [(&str, (f64, f64)); 32] = [
        ("AA/.T", (0.2, 2.3)),
        ("AC/.G", (-6.3, -17.1)),
        ("AG/.C", (-3.7, -10.0)),
        ("AT/.A", (-2.9, -7.6)),
...
pub fn tri_tetra_loops() -> &'static BpEnergy {
    pub static RAW_TRI_TETRA_LOOPS: [(&str, (f64, f64)); 131] = [
        ("AGAAT", (-1.5, 0.0)),
        ("AGCAT", (-1.5, 0.0)),
        ("AGGAT", (-1.5, 0.0)),
        ("AGTAT", (-1.5, 0.0)),
...
pub fn internal_loops() -> &'static LoopEnergy {
    pub static RAW_INTERNAL_LOOPS: [(u64, (f64, f64)); 30] = [
        (1, (0.0, 0.0)),
        (2, (0.0, 0.0)),
        (3, (0.0, -10.3)),
        (4, (0.0, -11.6)),
...
pub fn bulge_loops() -> &'static LoopEnergy {
    pub static RAW_BULGE_LOOPS: [(u64, (f64, f64)); 30] = [
        (1, (0.0, -12.9)),
        (2, (0.0, -9.4)),
        (3, (0.0, -10.0)),
        (4, (0.0, -10.3)),
...
fn raw_hairpin_loops() -> &'static LoopEnergy {
    pub static RAW_HAIRPIN_LOOPS: [(u64, (f64, f64)); 30] = [
        (1, (0.0, 0.0)),
        (2, (0.0, 0.0)),
        (3, (0.0, -11.3)),
        (4, (0.0, -11.3)),
...
pub fn dna() -> &'static Engergies {
    pub static DNA: LazyLock<Engergies> = LazyLock::new(|| Engergies {
